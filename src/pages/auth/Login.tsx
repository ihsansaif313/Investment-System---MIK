        ...
        <Card glassmorphism className="backdrop-blur-lg">
          ...
          {showEmailVerificationError && (
            <div className="mb-6 bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-yellow-400 font-medium mb-1">Email Verification Required</h4>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              <Input label="Email" type="email" placeholder="your@email.com" value={email} onChange={e => setEmail(e.target.value)} error={errors.email} leftIcon={<UserIcon size={18} />} fullWidth />
